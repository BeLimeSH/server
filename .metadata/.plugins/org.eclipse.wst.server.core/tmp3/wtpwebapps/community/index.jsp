...
<body>
    <main>
        ...
        <!-- 
            ...
            * 경로 작성 시 
                외부 요청 주소(인터넷 주소, 최상위 : /community) X,
                내부 접근 경로(파일 경로, 최상위 : /webapp) O
        -->
        <!-- 내부 접근 절대 경로 -->
            		...
            		<c:when test="${ empty sessionScope.loginMember }">
            		    ...
            		    <form action="member/login" method="POST" name="login-form" onsubmit="return loginValidate()" >
        		            ...
        		            <fieldset id="id-pw-area">
		                        ...
		                        <section>
        		                    <button>로그인</button> <!-- button의 기본값은 submit -->
               		            </section>
                            ...
                            <c:if test="${ !empty cookie.savaId.value }">
     		                ...
     		                <label>
    		                    ...
    		                    <input type="checkbox" name="saveId" checked id="saveId"> 아이디 저장
     		                </label>
