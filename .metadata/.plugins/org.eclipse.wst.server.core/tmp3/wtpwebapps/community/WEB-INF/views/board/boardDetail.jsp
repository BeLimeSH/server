...
<body>
    ...
    <main>
        ...
        <section class="board-detail">
            ...
            <div class="board-btn-area">
                ...
                <!-- onclick="history.go(숫자);" 숫자만큼 이동하기(양수 : 앞으로 / 음수 : 뒤로) -> 내용이 남아있다!ㅇㅁㅇ -->
    ...
    <script>
        ...
        //jsp파일 : html, css, js, el, jstl 사용 가능
        //js 파일 : js, jQuery

        //Js 코드에서 EL/JSTL 작성 시 반드시 ""를 양쪽에 추가
